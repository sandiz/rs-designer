...
/**
 * @typedef {Object} ConstantQSpectrogramPluginParams
 ...
 * });
 */
export default class ConstantQSpectrogramPlugin {
    /**
     ...
     *
     * @param  {ConstantQSpectrogramPluginParams} params Parameters used to initialise the plugin
    ...
    static create(params) {
        return {
            ...
            instance: ConstantQSpectrogramPlugin
        };
    }
    ...
    createWrapper() {
        const prevSpectrogram = this.container.querySelector('constantqgram');
        if (prevSpectrogram) {
            this.container.removeChild(prevSpectrogram);
        }
        const wsParams = this.wavesurfer.params;
        this.wrapper = document.createElement('constantqgram');
