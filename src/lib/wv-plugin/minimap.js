...
export default class MinimapPlugin {
    ...
    createElements() {
        ...
        this.drawer.style(this.drawer.progressWave, {
    ...
    bindMinimapEvents() {
        ...
        if (this.params.interact) {
            ...
            this.on('click', (event, position) => {
                if (seek) {
                    this.updateProgressWave(position);
    ...
    updateProgressWave(position = null) {
        if (position == null)
            this.drawer.updateProgressViaWidth(this.drawer.container.offsetWidth * this.wavesurfer.backend.getPlayedPercents());
        else
            this.drawer.updateProgressViaWidth(this.drawer.container.offsetWidth * position);
    }
